...
static std::map<Instruction, InstructionInfo> const c_instructionInfo = {
	...
	{Instruction::FETCHURL, {"FETCHURL", 0, 2, 1, true, Tier::Special}},
};
...
InstructionInfo solidity::evmasm::instructionInfo(Instruction _inst, langutil::EVMVersion _evmVersion)
{
	...
	catch (...)
	{
		return InstructionInfo(
			{"<INVALID_INSTRUCTION: " + std::to_string(static_cast<unsigned>(_inst)) + ">",
			 0,
			 0,
			 0,
			 false,
...
bool solidity::evmasm::isValidInstruction(Instruction _inst) { return !!c_instructionInfo.count(_inst); }
